                                ...
                                @foreach ($materials as $material)
                                    <tr>
                                        <td>
                                            <i
                                                class="fas
                                            @switch(strtolower(pathinfo($material->title, PATHINFO_EXTENSION)))
                                        ...
                                        <td>{{ $material->instructor->user->name ?? 'N/A' }}</td>
                                        <td>
                                            <a href="{{ Storage::url($material->material_link) }}" target="_blank"
